...
>>>>>>> 3add0d598abce02b7ea8f9eea392e21d8b2edfc4
...
xtable(as.matrix(cm_glm$table), label = "GLM confusion matrix")

xtable(as.matrix(cm_glm$byClass), label = "GLM performance")
=======
cm_glm
...
xtable(as.matrix(cm_rf$table), label = "Random Forest confusion matrix")

xtable(as.matrix(cm_rf$byClass), label = "Random Forest performance")
...
xtable(as.matrix(cm_xgb$table), label = "xgBoost confusion matrix")

xtable(as.matrix(cm_xgb$byClass), label = "xgBoost performance")
...
stargazer(comp_table$statistics, header = FALSE, label = c("Accuracy","Kappa"))
