...
```{r, cache = TRUE, fig.asp=1, fig.width = 14, cache=TRUE}
...
```{r, cache = TRUE, fig.asp=1, fig.width = 14, eval = TRUE, cache= FALSE}
#Model 3: Xgboost
...
```{r tuning_rf, echo=FALSE, cache = TRUE, out.width='100%', fig.cap="\\label{fig:tuning_rf}Tuning of Random Forest model"}
...
```{r tuning_xgb, echo=FALSE, cache = TRUE, out.width='100%', fig.cap="\\label{fig:tuning_xgb}Tuning of xgboost model"}
